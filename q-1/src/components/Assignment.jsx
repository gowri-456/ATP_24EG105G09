...
function Assignment() {
  ...
  return (
    <div className="bg-orange-200 min-h-screen flex flex-col items-center justify-center">

      {/* FORM BOX */}
      <div className="bg-emerald-200 shadow-xl rounded-2xl p-10 m-5 w-full max-w-md">
        ...
        <form className="mt-5" onSubmit={handleSubmit(onFormSubmit)}>
          ...
          <div className="flex justify-center">
            <button className="bg-indigo-300 p-2 rounded-md text-white">
              Add User
            </button>
          </div>
        </form>
      ...
      {/* USER LIST */}
      <div className="bg-cyan-100 shadow-xl rounded-2xl p-6 w-full max-w-md">
